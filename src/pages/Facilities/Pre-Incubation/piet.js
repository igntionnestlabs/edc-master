                    ...
                    <div className="container flex justify-center text-center">
                        <div className='z-[50] sticky '>
                            <div className='md:flex hidden mt-2 flex-col' >
                                ...
                                <p className=' mt-3 text-sm md:text-xl font-normal'>Parul Institution of Engineering and Technology</p>
                            </div>

                            <div className='md:hidden flex flex-col'>
                                <h1 className='text-3xl font-semibold uppercase'>INSTITUTION <br /> INNOVATION CLUB</h1>
                                <p className=' mt-1 text-base md:text-3xl font-medium'>Parul Institution of Engineering and Technology</p>
                            </div>
